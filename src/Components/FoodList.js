    ...
    <>
      <Card key={k} style={{ width: '310px', height: '370px', marginLeft: '20px' }} >
        ...
        <CardActions disableSpacing>
          <Button onClick={() => AddItemHandler(i.id)} style={{ marginRight: '10px' }} variant="contained" color="primary">
            <AddIcon />
          </Button>
          {i.totalItem===true && i.Qty>0 ? <>
            <Button onClick={() => RemoveItemHandler(i.id)} style={{ marginRight: '10px' }} variant="contained" decreaseItems color="secondary">
            <RemoveIcon />
          </Button>
          </> :<>
